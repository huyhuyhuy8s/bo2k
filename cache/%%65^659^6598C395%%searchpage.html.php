<?php 
 ob_start(); ?><?php /* Smarty version 2.6.19, created on 2024-10-10 10:03:10
...
<li class="active"> <?php   echo Core_CLanguage::_('SEARCH');  ?></li>
</ul>
<div class="row-fluid">
<span class="visible-desktop">
<div class="span9">
<div class="title_fnt">
<h1><?php   echo Core_CLanguage::_('SEARCH_RESULT');  ?> : <?php echo $this->_tpl_vars['countrecords']; ?>
</h1><span class="pull-right"><a href="<?php echo $_SESSION['base_url']; ?>
/index.php?do=search&action=grid&search=<?php echo $_GET['search']; ?>
" class="grid_icn"></a> <a href="<?php echo $_SESSION['base_url']; ?>
/index.php?do=search&search=<?php echo $_GET['search']; ?>
