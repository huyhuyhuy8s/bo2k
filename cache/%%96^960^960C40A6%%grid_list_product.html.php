<?php 
 ob_start(); ?><?php /* Smarty version 2.6.19, created on 2024-10-10 09:37:34
...
<!-- <li><a href="<?php echo $_SESSION['base_url']; ?>
/index.php?do=viewproducts&action=grid&cat=<?php echo $this->_tpl_vars['totcategory'][0]; ?>
"><?php echo $this->_tpl_vars['totcategory'][0]; ?>
</a> <span class="divider">/</span></li>
<li > <a href="<?php echo $_SESSION['base_url']; ?>
/index.php?do=viewproducts&action=grid&cat=<?php echo $this->_tpl_vars['totcategory'][0]; ?>
&subcat=<?php echo $this->_tpl_vars['totcategory'][1]; ?>
