<?php 
 ob_start(); ?><?php /* Smarty version 2.6.19, created on 2024-10-10 09:21:26
compiled from digitaleditproduct.html */ ?>
...
{
if ((document.productupdate.product_title.value=='') || (document.productupdate.sku.value==''))
{
...
else if ( isNaN(document.productupdate.price.value)|| isNaN(document.productupdate.msrp_org.value))
{
...
<div class="row-fluid">
<div class="span9"><h2> Edit DIGITAL PRODUCT
</h2>
</div>
<div class="span3" >
<ul class="bttn_right">
...
<form name="productupdate" id="editProductdetails" action="?do=manageproducts&action=updatedigitprod&prodid=<?php echo $this->_tpl_vars['id']; ?>
...
<?php echo $this->_tpl_vars['editMainCategory']; ?>
...
<input name="product_title" id="product_title" value="<?php echo $this->_tpl_vars['product_title']; ?>
"  type="text" size="50" />
</div>
</div>
<div class="row-fluid">
...
<div class="row-fluid"><div class="span5"><label>Upload File<font color="#FF0000">*</font></label>
...
</div><div class="span4"><p style="padding:25px"><a href="<?php echo $this->_tpl_vars['digitalfilepath']; ?>
"><button class="btn btn-primary" type="button">Download File</button></a></i></p></div>
</div>
<div class="row-fluid">
...
<div id="sku"><input name="sku" id="sku" type="text"  value="<?php echo $this->_tpl_vars['sku']; ?>
"/>
...
<TD align="left"><textarea style="width: 279px; height: 159px;" id="meta_desc" name="meta_desc"><?php echo $this->_tpl_vars['meta_desc']; ?>
</textarea>
