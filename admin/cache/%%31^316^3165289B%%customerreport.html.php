<?php 
 ob_start(); ?><?php /* Smarty version 2.6.19, created on 2024-10-10 15:30:31
...
$('#customerExportbutton').click(function(){
$("#exportForm").submit();
});
});
</script>
...
<div class="row-fluid">
<div class="span9"><h2>Export Customer</h2>
</div>
<div class="span3" >
<ul class="bttn_right">
<li><a href="javascript:void(0);" class="export_icon"  id="customerExportbutton"></a></li>
</ul>
</div>
</div>
</div>
...
<div class="clsblock">
<div class="clearfix">
<form name="export" id="exportForm" method="post" action="?do=excelreport">
<div class="bs-docs-example">
<div class="alert fade in">
<strong>Note:</strong> You can Export customers to the following format on your computer.
</div>
</div>
